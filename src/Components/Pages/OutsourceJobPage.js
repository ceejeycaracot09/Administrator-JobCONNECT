    ...
    <div style={containerStyle}>
      ...
      <div style={contentStyle}>
        <div style={columnStyle}>
          <div style={boxStyle}>
            <h2>Job Outsourced</h2>
            <p>Number of job outsourced: 50</p>
          </div>
        </div>
        <div style={columnStyle}>
          <div style={boxStyle}>
            <h2>Indeed</h2>
            <p>Number of job posts on Indeed: 30</p>
          </div>
        </div>
